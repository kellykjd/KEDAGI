...
public class DatosDao {
    ...
    public void traerArtistas(ResultListener<List<Artista>> listenerDelArtistaController){
        ...
        artistas.add(new Artista("Ricky Martin", R.drawable.rickymartin,"Enrique Martín Morales (San Juan, 24 de diciembre de 1971), conocido por su nombre artístico Ricky Martin, es un cantante, actor y escritor puertorriqueño nacionalizado español.7\u200B Inició su carrera musical a mediados de la década de los 80, como vocalista de un grupo juvenil llamado Menudo."));

        listenerDelArtistaController(artistas);
    }

    public void traerGeneros (ResultListener<List<Genero>> listenerDelArtistaController){
        List<Genero> generos = new ArrayList<>();

        generos.add(new Genero("Rock",R.drawable.rock,null));
        generos.add(new Genero("Pop",R.drawable.pop,null));
        ...
        listenerDelArtistaController(generos);
    }

    public void traerCanciones (ResultListener<List<Cancion>> listenerDelArtistaController){
